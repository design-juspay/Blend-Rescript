...
@module("react")
external useImperativeHandle: (Js.Nullable.t<ref<'value>>, @uncurry unit => 'value, 'deps) => unit =
  "useImperativeHandle"
...
external check: (~size: int=?, ~color: string=?, ~className: string=?) => React.element = "Check"
