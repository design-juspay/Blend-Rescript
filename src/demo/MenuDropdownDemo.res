...
module Dropdown = {
  ...
  type dropdownType = [
    ...
    | #multiSelect // backward compatibility
  ]
  ...
  type dropdownSubType = [
    ...
    | #menuButton // backward compatibility
  ]
...
let make = () => {
  ...
  <div className="space-y-10 p-6">
    ...
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-xl font-semibold mb-4"> {"Multi-select MenuDropdown"->React.string} </h2>
        
        <div className="space-y-8">
          <div>
            <h3 className="text-lg font-medium mb-2"> {"Count Display (HAS_CONTAINER)"->React.string} </h3>
            <div className="flex flex-wrap gap-4">
              {
          ...
          <div>
            <h3 className="text-lg font-medium mb-2"> {"Text Display (HAS_CONTAINER)"->React.string} </h3>
            <div className="flex flex-wrap gap-4">
              <Dropdown.make
          ...
          <div>
            <h3 className="text-lg font-medium mb-2"> {"NO_CONTAINER with Text Display"->React.string} </h3>
            <div className="flex flex-wrap gap-4">
              <Dropdown.make
                type_=#MULTI_SELECT
                subType=#NO_CONTAINER
