...
module OTPInputDemo = {
  ...
  let make = () => {
    ...
    <div className="p-4 space-y-8">
      ...
      <div className="border rounded p-4">
        <h2 className="text-xl font-semibold mb-4"> {"OTP Input with Resend Option"->React.string} </h2>
        <div className="space-y-4 max-w-md">
          <div>
            <OTPInput
      ...
      <div className="border rounded p-4">
        <h2 className="text-xl font-semibold mb-4"> {"OTP Input with Custom Styling"->React.string} </h2>
        <div className="space-y-4 max-w-md">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-lg font-medium text-gray-800 mb-2">{"Verify your identity"->React.string}</h3>
            <p className="text-sm text-gray-600 mb-4">{"We've sent a 4-digit verification code to +1 (***) ***-7890"->React.string}</p>
            <OTPInput
              digits=#"4"
              value={otpValue4}
              onChange={handleOtp4Change}
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <button
                className={`px-4 py-2 rounded-md text-white font-medium ${otpValue4->Js.String2.length === 4 ? "bg-blue-600 hover:bg-blue-700" : "bg-gray-300 cursor-not-allowed"}`}
