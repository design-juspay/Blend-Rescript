    ...
    <div className="p-4 space-y-8">
      ...
      <div className="border rounded p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <TextArea label="Default State" placeholder="Default state" state=#default rows={3} />
          <TextArea label="Hover State" placeholder="Hover state" state=#hover rows={3} />
          <TextArea label="Focused State" placeholder="Focused state" state=#focused rows={3} />
          <TextArea
            label="Filled State"
          ...
          />
          <TextArea label="Disabled State" placeholder="Disabled state" state=#disabled rows={3} />
        </div>
      </div>
      <div className="border rounded p-4">
        <h2 className="text-xl font-semibold mb-4">
          {"TextArea with Different Rows"->React.string}
        </h2>
        <div className="space-y-4 max-w-md">
          <TextArea
        ...
        <div className="space-y-6">
          <div className="border p-4 rounded-lg bg-gray-50">
            ...
            <div className="flex justify-between items-center">
              <div className="text-sm text-gray-600">
                {`${feedbackValue
                  ->Js.String2.length
                  ->Belt.Int.toString}/500 characters`->React.string}
              </div>
              <button
                className={`px-4 py-2 rounded-md text-white font-medium ${feedbackValue->Js.String2.length > 0
          ...
          <div className="border p-4 rounded-lg bg-gray-50">
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                className={`px-4 py-2 rounded-md text-white font-medium ${bioValue->Js.String2.length > 0 &&
